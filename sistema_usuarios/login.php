    ...
    <section class = "section_hero">
        <div class = "hero">
            <div class = "container">
                        ...
                        <form onsubmit="return false">
                            <div class = "row">
                                ...
                                <div class = "input-field col s12">
                                    ...
                                    <label for="icon_prefix">Ingresa con tu Usuario o email</label>
                                </div><!--Termina la columna-->
                                    <!-- CONTRASEÑA -->
                                <div class = "input-field col s12">
                                    <i class="material-icons prefix">lock_outline</i>
                                    <input id="icon_prefix" type="password" id="password" class="validate">
                                    <label for="icon_prefix">Ingresa tu contraseña Contraseña</label>
                                </div><!--Termina la columna-->
                            </div><!--Termina row-->    
                        </form>
                    </div>
                ...
                <div class="col s12">
                    <div class = "center">
                        <input type="submit" class="waves-effect waves-light btn blue-grey" value="Ingresar">
                    </div>
                </div>
            </div>
        </div>
